...
export const Products = () => {
  ...
  return (
    <Section id="products" title={t('products.title')}>
      <motion.div
        className="relative overflow-hidden rounded-3xl border border-primary/30 bg-gradient-to-br from-primary/20 via-background/80 to-background/95 p-8 shadow-lg"
      ...
      >
        <div
          className="absolute inset-y-0 right-0 hidden w-1/2 bg-[radial-gradient(circle_at_top,_rgba(31,182,255,0.4),_transparent_65%)] md:block"
          aria-hidden="true"
        />
